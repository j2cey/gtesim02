 ...
 */
class AddClientEsimEmailAddressRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'email_address' => array_merge(EmailAddress::createRules($this->email_address, ClientEsim::class)['email_address'], []),

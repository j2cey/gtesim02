 ...
 */
class ComparisonEqual extends BaseModel implements IInnerComparison
{
    ...
    public static function createNew(array $attributes = []): ComparisonEqual
    {
        return ComparisonEqual::create();
    }

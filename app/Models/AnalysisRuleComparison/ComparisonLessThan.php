 ...
 */
class ComparisonLessThan extends BaseModel implements IInnerComparison
{
    ...
    public static function createNew(array $attributes = []): ComparisonLessThan
    {
        return ComparisonLessThan::create();
    }

...
use App\Models\ExecTrace\HasExecTraces;
 ...
 */
class Treatment extends  BaseModel implements Auditable, IHasReportFile, IHasCollectedReportFile, IHasDynamicRow, IHasDynamicValue, IHasProgression, IHasExecTrace
{
